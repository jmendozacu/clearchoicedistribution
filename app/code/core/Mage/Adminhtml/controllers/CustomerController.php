...
class Mage_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
{
	...
	$templateId = 3;//here you can use template id defined in XML or you can use template ID in database (would be 1,2,3,4 .....etc)
	$mailSubject = 'Your application has been Rejected';
	$from			=	'Clear Choice Distribution';
	$fromemail			=	'admin@clearchoicedistribution.com';
		$sender = array('name' => $from,
		'email' => $fromemail);
		$email = $customer->getEmail();;

		$name = 'Clear Choice Distribution';
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            if(isset($data['account']['businessname']))
             {
              
                 $customer->setData('businessname',$data['account']['businessname']);
                
             } 
            if(isset($data['account']['businesswebsite']))
             {
              
                 $customer->setData('businesswebsite',$data['account']['businesswebsite']);
                
             } 
            if(isset($data['account']['typeofbusiness']))
             {
              
                 $customer->setData('typeofbusiness',$data['account']['typeofbusiness']);
                
             } 
            if(isset($data['account']['dateestdmonth']))
             {
              
                 $customer->setData('dateestdmonth',$data['account']['dateestdmonth']);
                
             } 
            if(isset($data['account']['dateestdyear']))
             {
              
                 $customer->setData('dateestdyear',$data['account']['dateestdyear']);
                
             } 
            if(isset($data['account']['businesslicensenumber']))
             {
              
                 $customer->setData('businesslicensenumber',$data['account']['businesslicensenumber']);
                
             } 
            if(isset($data['account']['businesslicensecopy']))
             {
              
                 $customer->setData('businesslicensecopy',$data['account']['businesslicensecopy']);
                
             } 
            if(isset($data['account']['sellerpermitnumber']))
             {
              
                 $customer->setData('sellerpermitnumber',$data['account']['sellerpermitnumber']);
                
             } 
            if(isset($data['account']['sellerpermitnumbercopy']))
             {
              
                 $customer->setData('sellerpermitnumbercopy',$data['account']['sellerpermitnumbercopy']);
                
             } 
            if(isset($data['account']['ein']))
             {              
                 $customer->setData('ein',$data['account']['ein']);                
             } 
            if(isset($data['account']['legalstatus']))
             {              
                 $customer->setData('legalstatus',$data['account']['legalstatus']);                
             } 
              ...
              * */
            if(isset($data['account']['btrefrencebusinessname']))
             {              
                 $customer->setData('btrefrencebusinessname',$data['account']['btrefrencebusinessname']);                
             }
                           
            if(isset($data['account']['btrefrencecontactname']))
             {              
                 $customer->setData('btrefrencecontactname',$data['account']['btrefrencecontactname']);                
             }
                           
            if(isset($data['account']['btrefrencetelephone']))
             {              
                 $customer->setData('btrefrencetelephone',$data['account']['btrefrencetelephone']);                
             }
                           
            if(isset($data['account']['btrefrencefax']))
             {              
                 $customer->setData('btrefrencefax',$data['account']['btrefrencefax']);                
             }
                           
            if(isset($data['account']['street_11']))
             {              
                 $customer->setData('street_11',$data['account']['street_11']);                
             }
                           
            if(isset($data['account']['city1']))
             {              
                 $customer->setData('city1',$data['account']['city1']);                
             }
                           
            if(isset($data['account']['region_id1']))
             {              
                 $customer->setData('region_id1',$data['account']['region_id1']);                
             }
                           
            if(isset($data['account']['region1']))
             {              
                 $customer->setData('region1',$data['account']['region1']);                
             }
                           
            if(isset($data['account']['zip1']))
             {              
                 $customer->setData('zip1',$data['account']['zip1']);                
             }
                           
            if(isset($data['account']['country1']))
             {              
                 $customer->setData('country1',$data['account']['country1']);                
             }
                           
            if(isset($data['account']['btrefrenceemail']))
             {              
                 $customer->setData('btrefrenceemail',$data['account']['btrefrenceemail']);                
             }
                           
            if(isset($data['account']['btrefrencebusinesswebsite']))
             {              
                 $customer->setData('btrefrencebusinesswebsite',$data['account']['btrefrencebusinesswebsite']);                
             }                           
              ...
              * */
            if(isset($data['account']['btrefrencebusinessname2']))
             {              
                 $customer->setData('btrefrencebusinessname2',$data['account']['btrefrencebusinessname2']);                
             }
                           
            if(isset($data['account']['btrefrencecontactname2']))
             {              
                 $customer->setData('btrefrencecontactname2',$data['account']['btrefrencecontactname2']);                
             }
                           
            if(isset($data['account']['btrefrencetelephone2']))
             {              
                 $customer->setData('btrefrencetelephone2',$data['account']['btrefrencetelephone2']);                
             }
                           
            if(isset($data['account']['btrefrencefax2']))
             {              
                 $customer->setData('btrefrencefax2',$data['account']['btrefrencefax2']);                
             }
                           
            if(isset($data['account']['street_12']))
             {              
                 $customer->setData('street_12',$data['account']['street_12']);                
             }
                           
            if(isset($data['account']['city2']))
             {              
                 $customer->setData('city2',$data['account']['city2']);                
             }
                           
            if(isset($data['account']['region_id2']))
             {              
                 $customer->setData('region_id2',$data['account']['region_id2']);                
             }
                           
            if(isset($data['account']['region2']))
             {              
                 $customer->setData('region2',$data['account']['region2']);                
             }
                           
            if(isset($data['account']['zip2']))
             {              
                 $customer->setData('zip2',$data['account']['zip2']);                
             }
                           
            if(isset($data['account']['country2']))
             {              
                 $customer->setData('country2',$data['account']['country2']);                
             }
                           
            if(isset($data['account']['btrefrenceemail2']))
             {              
                 $customer->setData('btrefrenceemail2',$data['account']['btrefrenceemail2']);                
             }
                           
            if(isset($data['account']['btrefrencebusinesswebsite2']))
             {              
                 $customer->setData('btrefrencebusinesswebsite2',$data['account']['btrefrencebusinesswebsite2']);                
             }                           
