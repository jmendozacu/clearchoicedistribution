		...
		if ( !empty( $importData['gallery'] ) ) {
            ...
            foreach( $galleryData as $gallery_img ) {
                try {
						...
						if($gallery_img==$importData["com_image"]){
								if($counterT==0){
									if((empty( $importData['com_thumbnail'] ) && empty( $importData['com_small_image'] )) || ($importData['com_thumbnail']==$importData["com_image"] && $importData['com_small_image']==$importData["com_image"])){		
										$visibility1 = array (
															'thumbnail',
															'small_image',
															'image'
